...
PROMPT_ADDON = """\
МОДУЛЬ КАЛЕНДАРЯ включён.
— в утреннем чекине вызови gcal_today и покажи встречи на сегодня (время + название).
— если спрашивают про сегодня — gcal_today.
— если спрашивают про завтра или ближайшие дни — gcal_upcoming с hours=48.
— если просят «поставь встречу / добавь в календарь / создай зум» — gcal_create_event (время в ISO).
